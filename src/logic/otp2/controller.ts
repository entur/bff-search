...
async function getTripPatterns(
    ...
    // TODO: There is a mismatch between types here and return type
    const res = await sdk.queryJourneyPlanner<{
        trip: {
            // TODO: We say that trip must contain metadata but in the return we say undefines
            // and we also have separate handling for undefined metadata
            metadata: Metadata
            tripPatterns: any[]
