...
export type Scalars = {
    ...
    Coordinates: {
        input: Array<[lat: number, lon: number]>
        output: Array<[lat: number, lon: number]>
    }
    Date: { input: string; output: string }
    DateTime: { input: string; output: string }
    DoubleFunction: { input: string; output: string }
...
export type RelaxCostInput = {
    ...
    constant: InputMaybe<Array<Scalars['ID']['input']>>
...
export type LegFieldsFragment = {
    ...
    nextLegs: Array<{
        ...
        line: { __typename?: 'Line'; publicCode: string | null } | null
        toPlace: { __typename?: 'Place'; name: string | null }
        fromPlace: { __typename?: 'Place'; name: string | null }
    }> | null
    operator: {
        __typename?: 'Operator'
        id: string
...
export type ReplaceLegFieldsFragment = {
    __typename?: 'Leg'
    id: string | null
    mode: Mode
    transportSubmode: TransportSubmode | null
...
export type GetTripPatternsQueryVariables = Exact<{
    ...
    arriveBy: Scalars['Boolean']['input']
...
export type ReplaceLegQueryVariables = Exact<{
    id: Scalars['ID']['input']
    numberOfNext: Scalars['Int']['input']
    numberOfPrevious: Scalars['Int']['input']
}>

export type ReplaceLegQuery = {
    __typename?: 'QueryType'
    leg: {
        __typename?: 'Leg'
        id: string | null
